...
# Short Straddle
positionconfigShortStraddle = [{"Type":defs.CALL,"Action":defs.SELL,"Delta":0, "SLPc":25, "TargetPc":50, "LotSize":1,
                       "SL": defs.YES, "Target":defs.NO},
                      {"Type":defs.PUT,"Action":defs.SELL,"Delta":0,"SLPc":25,"TargetPc":50,"LotSize":1,
                       "SL": defs.YES,"Target":defs.NO}]

# Long Straddle
positionconfigLongStraddle = [{"Type":defs.CALL,"Action":defs.BUY,"Delta":0, "SLPc":25, "TargetPc":50, "LotSize":1,
                       "SL": defs.YES, "Target":defs.NO},
                      {"Type":defs.PUT,"Action":defs.BUY,"Delta":0,"SLPc":25,"TargetPc":50,"LotSize":1,
                       "SL": defs.YES,"Target":defs.NO}]

def getStraddles(action, SL, Target, SLPc, TargetPc):
    positionconfig = [{"Type":defs.CALL,"Action":action, "Delta":0, "SLPc":SLPc, "TargetPc":TargetPc, "LotSize":1,
                       "SL": SL, "Target":Target},
                      {"Type":defs.PUT,"Action":action,"Delta":0,"SLPc":SLPc,"TargetPc":TargetPc,"LotSize":1,
                       "SL": SL,"Target":Target}]
    return positionconfig

# Short Strangle
positionconfigShortStrangle = [{"Type":defs.CALL,"Action":defs.SELL,"Delta":200, "SLPc":25, "TargetPc":50, "LotSize":1,
                       "SL": defs.YES, "Target":defs.NO},
                      {"Type":defs.PUT,"Action":defs.SELL,"Delta":-200,"SLPc":25,"TargetPc":50,"LotSize":1,
                       "SL": defs.YES,"Target":defs.NO}]

# Long Strangle
positionconfigLongStrangle = [{"Type":defs.CALL,"Action":defs.BUY,"Delta":200, "SLPc":25, "TargetPc":50, "LotSize":1,
                       "SL": defs.YES, "Target":defs.NO},
...
def getStrangles(action, Delta, SL, Target, SLPc, TargetPc):
    positionconfig = [{"Type":defs.CALL,"Action":action, "Delta":Delta, "SLPc":SLPc, "TargetPc":TargetPc, "LotSize":1,
                       "SL": SL, "Target":Target},
                      {"Type":defs.PUT,"Action":action,"Delta":-1*Delta,"SLPc":SLPc,"TargetPc":TargetPc,"LotSize":1,
                       "SL": SL,"Target":Target}]
    return positionconfig
...
def getIronButterfly(Delta, SLBuy, SLSell, Target, SLPcBuy, SLPcSell, TargetPc):
    positionconfig = [{"Type":defs.CALL,"Action":defs.BUY,"Delta":Delta, "SLPc":SLPcBuy, "TargetPc":TargetPc, "LotSize":1,
                       "SL": SLBuy, "Target":Target},
                      {"Type":defs.PUT,"Action":defs.BUY,"Delta":-1*Delta,"SLPc":SLPcBuy,"TargetPc":TargetPc,"LotSize":1,
                       "SL": SLBuy,"Target":Target},
                      {"Type": defs.CALL, "Action": defs.SELL, "Delta": 0, "SLPc": SLPcSell, "TargetPc": TargetPc,
                       "LotSize": 1, "SL": SLSell, "Target": Target},
...
def getIronCondor(Delta1, Delta2, SLBuy, SLSell, Target, SLPcBuy, SLPcSell, TargetPc):
    positionconfig = [{"Type":defs.CALL,"Action":defs.BUY,"Delta":Delta1 + Delta2, "SLPc":SLPcBuy, "TargetPc":TargetPc, "LotSize":1,
                       "SL": SLBuy, "Target":Target},
                      {"Type":defs.PUT,"Action":defs.BUY,"Delta":-1*(Delta1 + Delta2),"SLPc":SLPcBuy,"TargetPc":TargetPc,"LotSize":1,
                       "SL": SLBuy,"Target":Target},
