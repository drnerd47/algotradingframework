...
def get_RSIDualconfig_space_directional():
    cs = sp.Space()
...
def get_objective_function(config):
    ...
    (TIconfig, generalconfig, positionconfig) = GetConfigs.GetRSIDualConfigsPB(SL, defs.NO, SLPc, 70, Resample, 60,
                                                                    40, 90, 10, defs.BN, defs.BUY, defs.NO,
...
ref_point = [-1000,0]
space = get_RSIDualconfig_space_directional()
opt = Optimizer(
