...
def ReportTI(trades, Daily_Chart):
  rep = {}
...
def WeeklyBreakDown(Daily_Chart):
  weeklybreakdown = Daily_Chart.resample('W-Fri')[['Daily pnl']].sum()  
  return weeklybreakdown

def MonthlyBreakDown(Daily_Chart):
  Daily_Chart.sort_values(['Year', 'Month'])
  Monthly_BreakDown = Daily_Chart.groupby(['Year', 'Month'])[['Daily pnl']].sum()
  return Monthly_BreakDown


def DayOfWeek(Daily_Chart):
  Daily_Chart.sort_values(['DayOfWeek'])
  dayofweek = Daily_Chart.groupby(['DayOfWeek', 'Year'])[['Daily pnl']].sum()
  return dayofweek
