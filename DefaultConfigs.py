...
rsiadx_BNb = {'ADXTBear': 20, 'ADXTBull': 20, 'Delta': 0, 'Resample': 3, 'SL': defs.YES, 'Target': defs.NO, 'SLPc': 20, 'TargetPc': 70 ,
                'TBull': 60, 'TBear': 40, 'reenter': defs.NO, 'rolling': defs.NO, 'window': 14, 'symbol': defs.BN, 'action': defs.BUY, "TrailSL": defs.NO,
                 "SLTGContinuous": defs.YES, "MaxReEnterCounterBull": 5, "MaxReEnterCounterBear": 5}
...
rsiadx_Nb = {'ADXTBear': 20, 'ADXTBull': 20, 'Delta': 0, 'Resample': 9, 'SL': defs.YES, 'Target': defs.NO, 'SLPc': 35, 'TargetPc': 70,
                'TBull': 60, 'TBear': 40, 'reenter': defs.NO, 'rolling': defs.NO, 'window': 18, 'symbol': defs.N, 'action': defs.BUY,
                 "SLTGContinuous": defs.YES, "TrailSL": defs.NO, "MaxReEnterCounterBull": 5, "MaxReEnterCounterBear": 5}
...
rsi2_BNb = {"TBull1": 40, "TBear1": 60, "window1": 14, "TBull2": 10, "TBear2": 90, "window2":2,
            ...
            "MaxReEnterCounterBull": 5, "MaxReEnterCounterBear": 5}
...
rsi2_BNs = {"TBull1": 40, "TBear1": 60, "window1": 14,  "TBull2": 10, "TBear2": 90, "window2":2,
            ...
            'rolling': defs.YES, 'Resample': 10, 'reenter': defs.YES, "SLTGContinuous": defs.YES, 'Delta': 0, "TrailSL": defs.NO,
            "MaxReEnterCounterBull": 10, "MaxReEnterCounterBear": 10}
