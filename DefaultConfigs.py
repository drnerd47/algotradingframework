...
ind_straddle_BN_OL_RE = {"SquareOffSL":defs.ONELEG, "SquareOffTG": defs.ONELEG, "symbol": defs.BN, "ReEntrySL": defs.YES, "ReEntryTG": defs.NO, "REEvery":1, "TrailSL": defs.NO,
                "MaxReEnterCounterSL": 5, "MaxReEnterCounterTG": 6, "SLtoCost":defs.YES, "SL":defs.YES, "Target":defs.NO, "SLPc":25, "TargetPc":50, "Delta":1000, "DeltaThu":0, "OnlyThu": False,
                         "EnterTime": datetime.time(9, 17), "ExitTime": datetime.time(15, 15), "action": defs.SELL, "Limits": defs.NO}

# INTRADAY STRADDLE OL NIFTY
ind_straddle_N_OL_RE = {"SquareOffSL":defs.ONELEG, "SquareOffTG": defs.ONELEG, "symbol": defs.N, "ReEntrySL": defs.YES, "ReEntryTG": defs.NO, "REEvery":1, "TrailSL": defs.NO,
...
ind_straddle_BN_OL = {"SquareOffSL":defs.ONELEG, "SquareOffTG": defs.ONELEG, "symbol": defs.BN, "ReEntrySL": defs.NO, "ReEntryTG": defs.NO, "REEvery":14, "TrailSL": defs.NO,
                "MaxReEnterCounterSL": 5, "MaxReEnterCounterTG": 6, "SLtoCost":defs.NO, "SL":defs.YES, "Target":defs.NO, "SLPc":90, "TargetPc":75, "Delta":500, "DeltaThu":0, "OnlyThu": False,
                         "EnterTime": datetime.time(9, 20), "ExitTime": datetime.time(15, 20), "action": defs.SELL, "Limits": defs.NO, "PNLLimit": -3000, "DrawdownLimit": -4000}

# INTRADAY STRADDLE OL BANKNIFTY
ind_straddle_BN_OL_BUY = {"SquareOffSL":defs.ONELEG, "SquareOffTG": defs.ONELEG, "symbol": defs.BN, "ReEntrySL": defs.NO, "ReEntryTG": defs.NO, "REEvery":14, "TrailSL": defs.NO,
                "MaxReEnterCounterSL": 5, "MaxReEnterCounterTG": 6, "SLtoCost":defs.NO, "SL":defs.YES, "Target":defs.YES, "SLPc":50, "TargetPc":90, "Delta":0, "DeltaThu":0, "OnlyThu": False,
                         "EnterTime": datetime.time(9, 30), "ExitTime": datetime.time(15, 15), "action": defs.BUY, "Limits": defs.NO, "PNLLimit": -10000, "DrawdownLimit": -10000}
...
ind_straddle_N_OL = {"SquareOffSL":defs.ONELEG, "SquareOffTG": defs.ONELEG, "symbol": defs.N, "ReEntrySL": defs.NO, "ReEntryTG": defs.NO, "REEvery":14, "TrailSL": defs.NO,
                "MaxReEnterCounterSL": 3, "MaxReEnterCounterTG": 6, "SLtoCost":defs.NO, "SL":defs.YES, "Target":defs.NO, "SLPc":60, "TargetPc":50, "Delta":200, "DeltaThu":0, "OnlyThu": False,
                         "EnterTime": datetime.time(9, 20), "ExitTime": datetime.time(15, 20), "action": defs.SELL, "Limits": defs.NO, "PNLLimit": -10000, "DrawdownLimit": -10000}
...
ind_straddle_BN_OLS2 = {"SquareOffSL":defs.ONELEG, "SquareOffTG": defs.ONELEG, "symbol": defs.BN, "ReEntrySL": defs.NO, "ReEntryTG": defs.NO, "REEvery":14, "TrailSL": defs.NO,
                "MaxReEnterCounterSL": 3, "MaxReEnterCounterTG": 6, "SLtoCost":defs.NO, "SL":defs.YES, "Target":defs.NO, "SLPc":15, "TargetPc":75, "Delta":500, "DeltaThu":500, "OnlyThu": False,
                         "EnterTime": datetime.time(9, 30), "ExitTime": datetime.time(15, 20), "action": defs.SELL, "Limits": defs.NO}

# INTRADAY STRADDLE OL BANKNIFTY
ind_straddle_BN_OLS_BUY = {"SquareOffSL":defs.ONELEG, "SquareOffTG": defs.ONELEG, "symbol": defs.BN, "ReEntrySL": defs.NO, "ReEntryTG": defs.NO, "REEvery":14, "TrailSL": defs.NO,
                "MaxReEnterCounterSL": 3, "MaxReEnterCounterTG": 6, "SLtoCost":defs.NO, "SL":defs.NO, "Target":defs.YES, "SLPc":15, "TargetPc":15, "Delta":500, "DeltaThu":500, "OnlyThu": False,
                         "EnterTime": datetime.time(9, 30), "ExitTime": datetime.time(15, 15), "action": defs.BUY, "Limits": defs.NO}
...
ind_straddle_N_OLS = {"SquareOffSL":defs.ONELEG, "SquareOffTG": defs.ONELEG, "symbol": defs.N, "ReEntrySL": defs.NO, "ReEntryTG": defs.NO, "REEvery":14, "TrailSL": defs.NO,
                "MaxReEnterCounterSL": 5, "MaxReEnterCounterTG": 6, "SLtoCost":defs.YES, "SL":defs.YES, "Target":defs.NO, "SLPc":15, "TargetPc":50, "Delta":0, "DeltaThu":0, "OnlyThu": False,
                         "EnterTime": datetime.time(10, 30), "ExitTime": datetime.time(15, 15), "action": defs.SELL, "Limits": defs.NO}
...
ind_straddle_BN_AL = {"SquareOffSL":defs.ALLLEGS, "SquareOffTG": defs.ONELEG, "symbol": defs.BN, "ReEntrySL": defs.YES, "ReEntryTG": defs.NO, "REEvery":1, "TrailSL": defs.NO,
                "MaxReEnterCounterSL": 5, "MaxReEnterCounterTG": 6, "SLtoCost":defs.NO, "SL":defs.YES, "Target":defs.NO, "SLPc":45, "TargetPc":50, "Delta":1000, "DeltaThu":0, "OnlyThu": False,
                         "EnterTime": datetime.time(9, 16), "ExitTime": datetime.time(15, 15), "action": defs.SELL, "Limits": defs.NO}
...
ind_straddle_BN_ALS = {"SquareOffSL":defs.ONELEGSL, "SquareOffTG": defs.ONELEGSL, "symbol": defs.BN, "ReEntrySL": defs.YES, "ReEntryTG": defs.NO, "REEvery":1, "TrailSL": defs.NO,
                "MaxReEnterCounterSL": 4, "MaxReEnterCounterTG": 6, "SLtoCost":defs.NO, "SL":defs.YES, "Target":defs.NO, "SLPc":25, "TargetPc":50, "Delta":500, "DeltaThu":500, "OnlyThu": False,
                         "EnterTime": datetime.time(10, 30), "ExitTime": datetime.time(14, 30), "action": defs.SELL, "Limits": defs.NO}

# INTRADAY STRADDLE OL Reentry on Closing Both Legs BANKNIFTY
ind_straddle_BN_ALS_BUY = {"SquareOffSL":defs.ONELEGSL, "SquareOffTG": defs.ONELEGSL, "symbol": defs.BN, "ReEntrySL": defs.NO, "ReEntryTG": defs.YES, "REEvery":1, "TrailSL": defs.NO,
                "MaxReEnterCounterSL": 4, "MaxReEnterCounterTG": 6, "SLtoCost":defs.NO, "SL":defs.NO, "Target":defs.YES, "SLPc":25, "TargetPc":50, "Delta":500, "DeltaThu":500, "OnlyThu": False,
                         "EnterTime": datetime.time(10, 30), "ExitTime": datetime.time(14, 30), "action": defs.SELL, "Limits": defs.NO}
...
rsiadx_BNb = {'ADXTBear': 20, 'ADXTBull': 20, 'Delta': 0, 'Resample': 3, 'SL': defs.YES, 'Target': defs.NO, 'SLPc': 20, 'TargetPc': 70 ,
                'TBull': 60, 'TBear': 40, 'reenter': defs.NO, 'rolling': defs.NO, 'window': 14, 'symbol': defs.BN, 'action': defs.BUY, "TrailSL": defs.NO,
                 "SLTGContinuous": defs.YES, "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}
...
rsiadx_Nb = {'ADXTBear': 20, 'ADXTBull': 20, 'Delta': 0, 'Resample': 9, 'SL': defs.YES, 'Target': defs.NO, 'SLPc': 35, 'TargetPc': 70,
                'TBull': 60, 'TBear': 40, 'reenter': defs.NO, 'rolling': defs.NO, 'window': 18, 'symbol': defs.N, 'action': defs.BUY,
                 "SLTGContinuous": defs.YES, "TrailSL": defs.NO, "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}
...
rsi2_BNb = {"TBull1": 40, "TBear1": 60, "window1": 14, "TBull2": 10, "TBear2": 90, "window2":2,
            ...
            "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}
...
rsi2_BNs = {"TBull1": 40, "TBear1": 60, "window1": 14,  "TBull2": 10, "TBear2": 90, "window2":2,
            ...
            'rolling': defs.YES, 'Resample': 10, 'reenter': defs.YES, "SLTGContinuous": defs.YES, 'Delta': 0, "TrailSL": defs.NO,
            "MaxBullReEnterCounter": 10, "MaxBearReEnterCounter": 10}
...
rsidual_Nb = {"TBull1": 60, "TBear1": 40, "window1": 12, "window2": 6, "TBull2": 90, "TBear2": 10,
            ...
            'rolling': defs.NO, 'Resample': 9, 'reenter': defs.YES, "Delta": 0, "SLTGContinuous": defs.YES, "TrailSL": defs.NO,
              "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}

# RSI-Dual BANKNIFTY SELL SIDE
rsidual_BNs = {"TBull1": 60, "TBear1": 40, "window1": 14, "window2": 2, "TBull2": 90, "TBear2": 10,
            "SL": defs.YES, "Target": defs.NO, "SLPc": 20, "TargetPc": 70, 'symbol': defs.BN, 'action': defs.SELL,
            'rolling': defs.NO, 'Resample': 19, 'reenter': defs.YES, "Delta": 0, "SLTGContinuous": defs.YES, "TrailSL": defs.NO, 'TrailSLPc': 10,
               "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5, 'EnterTime':datetime.time(9, 20), 'ExitTime': datetime.time(15, 20)}

# RSI-Dual NIFTY SELL SIDE
rsidual_Ns = {"TBull1": 60, "TBear1": 40, "window1": 14, "window2": 5, "TBull2": 90, "TBear2": 10,
            "SL": defs.YES, "Target": defs.NO, "SLPc": 20, "TargetPc": 70, 'symbol': defs.N, 'action': defs.SELL,
            'rolling': defs.NO, 'Resample': 3, 'reenter': defs.YES, "Delta": 0, "SLTGContinuous": defs.YES, "TrailSL": defs.NO, 'TrailSLPc': 10,
              "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}

# BB1 BANKNIFTY BUY SIDE
bb1_BNb = {"TBull": 0, "TBear": 1, "period": 20, "stddev":2, "Delta": 0, "SL": defs.YES, "Target": defs.YES, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.BUY, 'rolling': defs.YES, 'reenter': defs.YES, 'symbol': defs.BN, "SLTGContinuous": defs.YES, 'Resample': 3, "TrailSL": defs.NO, 'TrailSLPc': 10,
           "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}

# BB1 NIFTY BUY SIDE
bb1_Nb = {"TBull": 0, "TBear": 1, "period": 20, "stddev":2, "Delta": 0, "SL": defs.YES, "Target": defs.YES, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.BUY, 'rolling': defs.YES, 'reenter': defs.YES, 'symbol': defs.N, "SLTGContinuous": defs.YES, 'Resample': 3, "TrailSL": defs.NO, 'TrailSLPc': 10,
          "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}
...
bb1_BNs = {"TBull": 0, "TBear": 1, "period": 20, "stddev":2, "Delta": 0, "SL": defs.YES, "Target": defs.YES, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.SELL, 'rolling': defs.YES, 'reenter': defs.YES, 'symbol': defs.BN, "SLTGContinuous": defs.YES, 'Resample': 7, "TrailSL": defs.NO, 'TrailSLPc': 10,
           "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}

# BB1 NIFTY SELL SIDE
bb1_Ns = {"TBull": 0, "TBear": 1, "period": 20, "stddev":2, "Delta": 0, "SL": defs.YES, "Target": defs.YES, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.SELL, 'rolling': defs.YES, 'reenter': defs.YES, 'symbol': defs.N, "SLTGContinuous": defs.YES, 'Resample': 3, "TrailSL": defs.NO, 'TrailSLPc': 10,
          "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}

# BB2 BANKNIFTY BUY SIDE
bb2_BNb = {"TBull": 1, "TBear": 0, "period": 20, "stddev":1, "Delta": 0, "SL": defs.YES, "Target": defs.YES, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.BUY, 'rolling': defs.NO, 'reenter': defs.YES, 'symbol': defs.BN, "SLTGContinuous": defs.YES, 'Resample': 3, "TrailSL": defs.NO, 'TrailSLPc': 10,
           "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}

# BB2 NIFTY BUY SIDE
bb2_Nb = {"TBull": 1, "TBear": 0, "period": 20, "stddev":1, "Delta": 0, "SL": defs.YES, "Target": defs.YES, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.BUY, 'rolling': defs.NO, 'reenter': defs.YES, 'symbol': defs.N, "SLTGContinuous": defs.YES, 'Resample': 3, "TrailSL": defs.NO, 'TrailSLPc': 10,
          "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}

# BB2 BANKNIFTY SELL SIDE
bb2_BNs = {"TBull": 1.5, "TBear": 0, "period": 16, "stddev":1, "Delta": 0, "SL": defs.YES, "Target": defs.NO, 'SLPc': 50, 'TargetPc': 70,
            'action': defs.SELL, 'rolling': defs.NO, 'reenter': defs.YES, 'symbol': defs.BN, "SLTGContinuous": defs.YES, 'Resample': 6, "TrailSL": defs.NO, 'TrailSLPc': 10,
           "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}

# BB2 NIFTY SELL SIDE
bb2_Ns = {"TBull": 1, "TBear": -0.2, "period": 24, "stddev":1, "Delta": 0, "SL": defs.YES, "Target": defs.NO, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.SELL, 'rolling': defs.NO, 'reenter': defs.YES, 'symbol': defs.N, "SLTGContinuous": defs.YES, 'Resample': 5, "TrailSL": defs.NO, 'TrailSLPc': 10,
          "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}
...
ema_BNb = {"TBull": 35, "TBear": -65, "period": 14, "SL": defs.YES, "Delta": 0, "Target": defs.NO, 'SLPc': 20, 'TargetPc': 70, 'Resample': 3,
            'action': defs.BUY, 'rolling': defs.NO, 'reenter': defs.YES, 'symbol': defs.BN, "SLTGContinuous": defs.YES, "TrailSL": defs.NO, 'TrailSLPc': 10,
           "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}

# EMA NIFTY BUY SIDE
ema_Nb = {"TBull": 20, "TBear": -30, "period": 14, "SL": defs.YES, "Delta": 0, "Target": defs.NO, 'SLPc': 20, 'TargetPc': 70, 'Resample': 3,
            'action': defs.BUY, 'rolling': defs.NO, 'reenter': defs.YES, 'symbol': defs.N, "SLTGContinuous": defs.YES, "TrailSL": defs.NO, 'TrailSLPc': 10,
          "MaxBullReEnterCounter": 5, "MaxBearReEnterCounter": 5}
