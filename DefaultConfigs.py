...
bb1_BNb = {"TBull": 0, "TBear": 1, "period": 20, "stddev":2, "Delta": 0, "SL": defs.YES, "Target": defs.YES, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.BUY, 'rolling': defs.YES, 'reenter': defs.YES, 'symbol': defs.BN, "SLTGContinuous": defs.YES, 'Resample': 3, 'TrailSLPc': 10}

# BB1 NIFTY BUY SIDE
bb1_Nb = {"TBull": 0, "TBear": 1, "period": 20, "stddev":2, "Delta": 0, "SL": defs.YES, "Target": defs.YES, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.BUY, 'rolling': defs.YES, 'reenter': defs.YES, 'symbol': defs.N, "SLTGContinuous": defs.YES, 'Resample': 3, 'TrailSLPc': 10}
...
bb1_BNs = {"TBull": 0, "TBear": 1, "period": 20, "stddev":2, "Delta": 0, "SL": defs.YES, "Target": defs.YES, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.SELL, 'rolling': defs.YES, 'reenter': defs.YES, 'symbol': defs.BN, "SLTGContinuous": defs.YES, 'Resample': 7, 'TrailSLPc': 10}

# BB1 NIFTY SELL SIDE
bb1_Ns = {"TBull": 0, "TBear": 1, "period": 20, "stddev":2, "Delta": 0, "SL": defs.YES, "Target": defs.YES, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.SELL, 'rolling': defs.YES, 'reenter': defs.YES, 'symbol': defs.N, "SLTGContinuous": defs.YES, 'Resample': 3, 'TrailSLPc': 10}
...
bb2_BNs = {"TBull": 1, "TBear": 0, "period": 20, "stddev":1, "Delta": 0, "SL": defs.YES, "Target": defs.NO, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.SELL, 'rolling': defs.NO, 'reenter': defs.YES, 'symbol': defs.BN, "SLTGContinuous": defs.YES, 'Resample': 3, "TrailSL": defs.NO, 'TrailSLPc': 10}

# BB2 NIFTY SELL SIDE
bb2_Ns = {"TBull": 1, "TBear": 0, "period": 20, "stddev":1, "Delta": 0, "SL": defs.YES, "Target": defs.NO, 'SLPc': 20, 'TargetPc': 70,
            'action': defs.SELL, 'rolling': defs.NO, 'reenter': defs.YES, 'symbol': defs.N, "SLTGContinuous": defs.YES, 'Resample': 3, "TrailSL": defs.NO, 'TrailSLPc': 10}
